<template><h2 id="如何在-wordpress-中註冊新選單" tabindex="-1"><a class="header-anchor" href="#如何在-wordpress-中註冊新選單" aria-hidden="true">#</a> 如何在 WordPress 中註冊新選單</h2>
<p>首先，需要在WordPress主題中的funciton.php文件中註冊新選單！</p>
